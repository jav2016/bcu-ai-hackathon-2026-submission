...
How I did it:
I used a Python script to search for evidence from web/Wikipedia and compare it with the answer options. After that I manually checked the risky answers because some first answers were not reliable.
